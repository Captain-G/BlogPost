...
{{--        bootstrap--}}
        ...
        <style>
            ...
            .myText{
                ...
                background: -webkit-linear-gradient(60deg, #a28712, black);
    ...
    <body class="antialiased">
        <div class="relative viewBlog items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-1 sm:pt-0">
{{--            @if (Route::has('login'))--}}
...
{{--            @endif--}}
                ...
                <div class="container-fluid" style="margin-top:-30px; display:flex; background: linear-gradient(to left, #F4D03F, #16A085)">
                <div class="col col-sm-8 col-md-8 col-lg-8 col-xl-8">

                    <div style="margin-top: 30px">
                        <h1 class="myText" style="font-family: 'Allerta Stencil';font-size: 50px; margin-left: 30px">
                            Read a blog, <br>
                        Just like the doctor ordered. <br>
                        </h1>
                        <div style="margin-left:250px">
                            <form method="get" action="{{ route('viewBlog') }}">
                                @csrf
                                <button type="submit" class="btn btn-lg btn-outline-dark myBtn">View blogs</button>
                            </form>
                        </div>

                    </div>
                    <div>
                        <h1 style="font-family: 'Allerta Stencil';font-size: 50px;margin-top: 150px; margin-left: 30px" class="myText">
                        ...
                        <div style="margin-left: 250px; margin-top: 20px">
                            <form method="get" action="{{ route('postBlog') }}">
                                @csrf
                                <button type="submit" class="btn btn-lg btn-outline-dark myBtn">Post a blog</button>
                            </form>
                        </div>
                    </div>
                </div>
...
{{--                        aeroplane - travel--}}
                        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-airplane-engines" viewBox="0 0 16 16">
                    ...
                    <div class="col col-sm-4 col-md-4 col-lg-4 col-xl-4">
{{--                        arrow through heart--}}
                        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-arrow-through-heart" viewBox="0 0 16 16">
...
{{--                        briefcase - business--}}
                    ...
                    <div class="row" style="margin-top: 30px">
                        <div class="col col-sm-4 col-md-4 col-lg-4 col-xl-4">
{{--                            camera--}}
                            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-camera2" viewBox="0 0 16 16">
...
{{--                            controller pad--}}
                        ...
                        <div class="col col-sm-4 col-md-4 col-lg-4 col-xl-4">
{{--                            money / currency--}}
                            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-currency-exchange" viewBox="0 0 16 16">
                    ...
                    <div class="row" style="margin-top: 30px">
                        <div class="col col-sm-4 col-md-4 col-lg-4 col-xl-4">
{{--                            basketball--}}
                            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-dribbble" viewBox="0 0 16 16">
                        ...
                        <div class="col col-sm-4 col-md-4 col-lg-4 col-xl-4">
{{--                            music--}}
                            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-headset" viewBox="0 0 16 16">
...
{{--                                twitter--}}
                            ...
                            <div class="col col-sm-4 col-md-4 col-lg-4 col-xl-4">
{{--                                snapchat--}}
                                <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-snapchat" viewBox="0 0 16 16">
...
{{--                                covid virus--}}
                            ...
                            <div class="col col-sm-4 col-md-4 col-lg-4 col-xl-4">
{{--                                wordpress--}}
                                <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-wordpress" viewBox="0 0 16 16">
                            ...
                            <div class="col col-sm-4 col-md-4 col-lg-4 col-xl-4">
{{--                                yin yang--}}
                                <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-yin-yang" viewBox="0 0 16 16">
