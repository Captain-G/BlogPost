...
{{--                    </button>--}}
    ...
    <div class="container">
        <div style="display: flex">
            ...
            <p style="margin-left: 20px">Timestamp when posted</p>
        </div>
        <div>
            <p>{{ $newBlogItem->commentContent }}</p>
        </div>
...
{{--                <p style="margin-top: 6px">12 likes</p>--}}
            </div>
...
{{--                <p style="margin-top: 12px">3 dislikes</p>--}}
            </div>
        </div>
        <hr>
        <div style="display: flex">
        ...
        <div>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi dignissimos ipsa obcaecati sequi? Animi asperiores autem esse et ex fugit impedit labore nostrum quae quas, reiciendis repellendus sapiente soluta vero.</p>
        </div>
        <div class="hasButtons" style="display: flex">
            <div style="display: flex">
                <button class="btn btn-sm btn-default" id="btnLike">
